...
//Include references
$sql = "SELECT LeagueID FROM ".$xoopsDB->prefix("cricket_leaguenames")." WHERE LeagueDefault=1";
$sql2 = "SELECT SeasonID FROM ".$xoopsDB->prefix("cricket_seasonnames")." WHERE SeasonDefault=1";
$cricket_league = $xoopsDB->query($sql);
$cricket_season = $xoopsDB->query($sql2);
...
//If All is chosen from league & season, lets set default value for %
...
//Gets leagues and match types for dropdowns
...
<td>
	...
	<h3><?php echo _LS_CRICK_LEAGUESTATS;?></h3>
	<?php echo _LS_CRICK_LEAGUEFILTER;?> <select name="league">
	...
	?>
	</select> <input type="submit" class="button" value=">>" name="submit1">
	</td>
	</tr>
	...
	LM.LeagueMatchAwayRuns IS NOT NULL
	");
	...
	LeagueMatchSeasonID LIKE '$cricket_defaultseasonid'
	");
